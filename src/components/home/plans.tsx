      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 flex flex-col items-center gap-2">
          <div className="grid grid-cols-2 gap-1 rounded-xl bg-ink-100 p-1 dark:bg-ink-800">
            ...
            >
              {t("plans.annual")}
              <span className="ms-1.5 rounded-full bg-emerald-500/15 px-1.5 py-0.5 text-[10px] font-black text-emerald-600 dark:text-emerald-400">
          ...
          {PLANS.map((plan, i) => (
            ...
            >
              ...
              <div className="mt-5 flex items-baseline gap-1">
                ...
                {annual && (
                  <span className="ms-1 rounded-full bg-emerald-500/15 px-2 py-0.5 text-[10px] font-black text-emerald-600 dark:text-emerald-400">
