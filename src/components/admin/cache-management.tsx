  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-xl p-4 border border-gray-200"><p className="text-2xl font-bold text-gray-900">{formatNumber(caches.reduce((s, c) => s + c.entries, 0))}</p><p className="text-sm text-gray-500">Total Entries</p></div>
