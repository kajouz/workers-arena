        ...
        <div className="space-y-4 py-4">
          {!maskedNumber ? (
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 rounded-lg bg-ink-50 dark:bg-ink-950 dark:bg-ink-800 border border-ink-200 dark:border-ink-800 dark:border-ink-700">
                ...
                <div className="flex items-center justify-between">
                  <p className="text-xl font-mono font-bold text-ink-900 dark:text-ink-50 dark:text-ink-100">
                  ...
                  <Button
                    ...
                    size="sm"
                    onClick={handleCopy}
                    className="text-ink-500 dark:text-ink-400 hover:text-ink-700 dark:hover:text-ink-200"
                  >
