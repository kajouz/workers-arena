...
/** City landing pages are a fixed, build-time list — prerender them per locale. */
...
export async function generateMetadata({ params }: CityPageProps): Promise<Metadata> {
  ...
  // hreflang + canonical: this page in both languages (see localeAlternates).
  const alternates = localeAlternates(`/${isLocale(rawLocale) ? rawLocale : defaultLocale}/cities/${city}`);
