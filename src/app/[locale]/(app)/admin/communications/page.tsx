    ...
    <div className="min-h-screen bg-ink-50 dark:bg-ink-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-ink-900 dark:text-ink-50">Communication Tools</h1>
          <p className="text-ink-600 dark:text-ink-300 mt-2">Manage email campaigns, push notifications, and promotional codes</p>
        </div>
