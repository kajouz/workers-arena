...
export default function CompanyError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  ...
  return (
    <div className="flex min-h-[50dvh] flex-col items-center justify-center px-4 py-10 text-center">
      ...
      <h1 className="mt-4 text-2xl font-black text-ink-900 dark:text-ink-50">Company dashboard error</h1>
      <p className="mt-2 max-w-md text-sm text-ink-500 dark:text-ink-400">Could not load the company dashboard. Please try again.</p>
