...
export const WORKER_RECIPES: readonly WorkerRecipe[] = [
  ...
  { category: "electrical", rating: 4.8, reviewCount: 98, yearsExp: 15, verified: true, premium: true, joinedYear: 2016, priceMin: 30, priceMax: 220, langCodes: ["ar", "en"], phonePrefixIndex: 1, phoneTail: "456 789", brand: "volt-lb", tld: "com", website: true },
  { category: "carpentry", rating: 4.7, reviewCount: 76, yearsExp: 10, verified: true, featured: true, joinedYear: 2018, priceMin: 60, priceMax: 320, langCodes: ["ar", "en", "fr"], phonePrefixIndex: 0, phoneTail: "778 219", brand: "woodcraft", website: true },
  ...
  { category: "ac-technician", rating: 4.9, reviewCount: 210, yearsExp: 9, verified: true, premium: true, featured: true, emergency: true, available: true, joinedYear: 2020, priceMin: 40, priceMax: 180, langCodes: ["ar", "en"], phonePrefixIndex: 1, phoneTail: "330 812", brand: "coolair", website: true },
  ...
  { category: "cleaning", rating: 4.9, reviewCount: 156, yearsExp: 6, verified: true, premium: true, featured: true, available: true, plan: "enterprise", joinedYear: 2021, priceMin: 40, priceMax: 180, langCodes: ["ar", "en"], phonePrefixIndex: 1, phoneTail: "902 113", brand: "sparkle", website: true },
