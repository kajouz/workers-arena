...
children.push(
  ...
  B("Badges: Verified (paid verification tiers), Featured (paid slot), Emergency (paid marker), and Business plan reduced take-rate treatment; fee waivers apply only when explicitly configured."),
  H3("Step by step"),
...
children.push(
  ...
  B("Admin can change a worker's plan inline (audited as ADMIN_PLAN_CHANGED with the acting admin's identity), reactivate an expired subscription, manage explicitly exempt fee rules, and export the worker table as CSV."),
  ...
  STEP(2, "For corrections: /admin worker-management table → change plan / reactivate / explicitly exempt-rule switch → confirm in the two-step dialog."),
...
children.push(
  ...
  B("Worker management table: search, plan-tier sort, explicitly fee-waived-rule filter, inline plan change (audited), CSV export of the current filtered view."),
...
children.push(
  ...
  TABLE(
    ...
    [
      ...
      ["Business", "$199/mo", "+ emergency marker, priority support, ads — and reduced 4% take rate by default"],
  ...
  B("Tiered rates: Free 12%, Starter 9%, Growth 7%, Pro 5%, Business 4% by default. Floor $5, cap $300 per job; an admin may explicitly configure a fee exemption."),
  B("Stamped once at accept-with-quote as an immutable snapshot on the booking; Business is reduced-rate by default. Admin can set explicit plan/category/promotion exemptions and other overrides."),
